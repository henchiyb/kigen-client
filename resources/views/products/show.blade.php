            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                  <img src="/{{ $product->images->first()->img_link }}" width="150" height="150" class="rounded-circle">
                  </a>
                </div>
              </div>
              ...
              <div class="col-lg-4 order-lg-1">
                <div class="card-profile-actions py-4 mt-lg-0 text-center">
                  ...
                  <div id="slider-container" class="mt-3">
                    ...
                    <img class="myImageSlides w3-animate-fading rounded-circle" onclick="openModal();currentSlide(1)" src="/{{ $product->images[$i]->img_link }}" style="width:80px; height: 80px; margin-left: auto; margin-right: auto">
                    @endfor
                  </div>
                  <p class="mt-3">Ảnh</p>
                </div>
    ...
    <div class="modal-content">
      @for ($i = 0; $i < sizeof($product->images); $i++)
        <div class="myModalSlides">
          <img src="/{{ $product->images[$i]->img_link }}" style="width:100%">
        </div>              
      @endfor
